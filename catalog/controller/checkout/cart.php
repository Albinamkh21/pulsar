...
class ControllerCheckoutCart extends Controller {
	...
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
            ...
            $data['text_checkout_continue'] = $this->language->get('text_checkout_continue');
            ...
            $data['action_updatecart'] = $this->url->link('checkout/checkout', '', true);
	...
	public function add() {
		...
		if ($product_info) {
			...
			if (!$json) {
                ...
                $json['total_cnt'] = $this->cart->countProducts() > 0 ? $this->cart->countProducts():0;
