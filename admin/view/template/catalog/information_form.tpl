              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group date">
                        <input data-date-format="YYYY-MM-DD" type="text" name="information_description[<?php echo $language['language_id']; ?>][date_added]" value="<?php echo isset($information_description[$language['language_id']]) ? $information_description[$language['language_id']]['date_added'] : ''; ?>" placeholder="<?php echo $entry_date_added; ?>" id="input-date_added<?php echo $language['language_id']; ?>" class=" date_added form-control" />
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="information_description[<?php echo $language['language_id']; ?>][source]" value="<?php echo isset($information_description[$language['language_id']]) ? $information_description[$language['language_id']]['source'] : ''; ?>" placeholder="<?php echo $entry_source; ?>" id="input-source<?php echo $language['language_id']; ?>" class="form-control" />
