              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($promo['promo_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $promo['title']; ?></td>
                  <td class="text-right"><?php echo $promo['sort_order']; ?></td>
                  <td class="text-right"><a href="<?php echo $promo['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
