...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
        ...
        $data['upload'] = $this->url->link('catalog/product/upload', 'token=' . $this->session->data['token'] . $url, true);
        ...
        $json = array();
         ...
         if(!empty($this->request->files)) {
             if (!empty($this->request->files['file']['name']) && is_file($this->request->files['file']['tmp_name'])) {
                 ...
                 if(!$json) {
                     $file = DIR_DOWNLOAD . $filename . '.' . token(32);

                     move_uploaded_file($this->request->files['file']['tmp_name'], $file);

                     $this->load->model('catalog/product');
                     $this->model_catalog_product->UploadDataToTmpTable($file);
                     $this->model_catalog_product->UploadDataToTable();
                 }
             ...
             if (!$json) {
                 ...
                 $json['filename'] = $this->request->files['file']['name'];
    ...
    public function getFormUpload() {
        ...
        $data['heading_title'] = $this->language->get('heading_title_upload');
        $data['button_save'] = $this->language->get('button_save');
        $data['button_cancel'] = $this->language->get('button_cancel');
        $data['button_upload'] = $this->language->get('button_upload');
        ...
        $data['action'] = $this->url->link('catalog/product/upload', 'token=' . $this->session->data['token'] . $url, true);
        $data['token'] = $this->session->data['token'];
        ...
        $this->response->setOutput($this->load->view('catalog/product_upload', $data));
