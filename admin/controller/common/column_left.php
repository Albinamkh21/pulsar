...
/*
            if ($this->user->hasPermission('access', 'catalog/customfilter')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_customfilter'),
                    'href'     => $this->url->link('catalog/customfilter', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
*/
            ...
            if ($this->user->hasPermission('access', 'catalog/promo')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_promo'),
                    'href'     => $this->url->link('catalog/promo', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
